...
def read_atmotube_file(file, timezone):
    ...
    df.index = (
        pd.to_datetime(df["datetime"], format="mixed")
...
def add_metadata(ds, params):
    ...
    ds["aqs"].attrs = {
        "long_name": "air quality score",
        "units": "None",
        "instrument": "Atmotube",
    }
    ds["pm1"].attrs = {
        "long_name": "PM1 mass concentration",
        "units": "µg/m3",
        "instrument": "Atmotube",
    }
    ds["pm25"].attrs = {
    ...
    ds["tvoc_index"].attrs = {
        "long_name": "total VOC index",
        "units": "None",
        "instrument": "Atmotube",
    }
    ds["tvoc"].attrs = {
        "long_name": "total VOC concentration",
        "units": "ppm",
        "instrument": "Atmotube",
    }
    ds["nox_index"].attrs = {
