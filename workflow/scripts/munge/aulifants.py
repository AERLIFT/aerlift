...
def add_metadata(ds: xr.Dataset, params: Any) -> xr.Dataset:
    ...
    ds["power"].attrs = {"long_name": "Power", "units": "W", "instrument": "Aulifants"}
    ds["power_factor"].attrs = {
        "long_name": "Power Factor",
        "units": "",
        "instrument": "Aulifants",
    }
    ds["cummulative_energy"].attrs = {
        "long_name": "Cumulative energy",
        "units": "kWh",
        "instrument": "Aulifants",
    }
    ds["cost"].attrs = {
        "long_name": "Energy cost",
        "units": "USD",
        "instrument": "Atmotube",
    }
    return ds
