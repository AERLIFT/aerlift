    ...
    class snakemake:
        class params:
            ...
            alphasense = {'position_1': 'NO2', 'position_2': 'O3',
                          'position_3': None,  'position_4': None}
        class input:
...
def add_metadata(ds, params):
    ...
    ds['sen_pm10_raw'].attrs           = {'long_name': 'Sensirion PM10 mass concentration',   'units': 'ug/m3'}
...
num_vars = [v for v in ds_hhb.data_vars
